...
class ExportDialog(QDialog, Ui_ExportDialog):
    ...
    def __exec(self, export: int):
        ...
        if package and package.instance and len(package.instances) > 1:
    ...
    def export(self):
        ...
        items = main_model.model.items

        package = self.main_window.packages_storage.package

        one_instance = package and package.instance and len(package.instances) == 1
        ...
        if self.__export == EXPORT_STBL:
            ...
            if separate_instances or separate_packages:
                ...
                if one_instance or current_instance and package:
                    ...
                    items = main_model.items(key=package.key)
        ...
        if filename:
            ...
            if separate_packages:
                for key, tables in packages.items():
                    package = self.main_window.packages_storage.find(key)
